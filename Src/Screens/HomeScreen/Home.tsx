    ...
    <Pressable
      ...
      <View style={[globalStyles.rowContainer]}>
        <View style={[{width: '45%', backgroundColor: 'transparent'}]}>
          <FadeTextSmall style={[{padding: 5}]}>{'2024-05-04'}</FadeTextSmall>
          <View
            style={[
            ...
            <View
              ...
              <View
                ...
                <MaterialCommunityIcons
                  name={
                    // item.item.status == 1
                    loading ? 'check-circle' : 'alert-circle'
                  }
                  size={10}
                  color={
                    // item.item.status == 1
